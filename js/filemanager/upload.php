...
try {
    ...
    $_FILES['files']['name'][0]=vn_str_co_dau_thanh_khong_dau($_FILES['files']['name'][0]);
    $_FILES['files']['name'][0] = preg_replace('/(\s){1,}/', '-', $_FILES['files']['name'][0]);
    $_FILES['files']['name'][0] = strtolower($_FILES['files']['name'][0]);
